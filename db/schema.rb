...
ActiveRecord::Schema.define(version: 20160822205726) do
  ...
  add_index "comentarios", ["accion_id"], name: "index_comentarios_on_accion_id"
  ...
  add_index "deals", ["contacto_id"], name: "index_deals_on_contacto_id"
